...
print("Str nump = ", nump, "nums = ", nums, "dt = ", dt, "D1 = ", D1, " D2 = ", D2, "N = ", N, "r = ", r, "--- %s seconds ---" % (time.time() - start_time))
...
plt.legend()
plt.savefig(f'Images/Hist_Str1_{N}_{R}_{r}_{nump}_{nums}_{D1}_{D2}.png')
#plt.show()
...
plt.savefig(f'Images/Prob_Str1_{N}_{R}_{r}_{nump}_{nums}_{D1}_{D2}.png')
#plt.show()
...
plt.ylabel("Time, t")
plt.colorbar()
plt.savefig(f'Images/Heat_Str1_{N}_{R}_{r}_{nump}_{nums}_{D1}_{D2}.png')
