# -*- coding: utf-8 -*-
"""2DWithRandomPores.ipynb

Aim : To simulate distribution of mean first passage times in 2D Heterogeneous media with N randomly distributed pores along the media boundary.
...
"""# Add pores randomly on the media boundary such that there is no overlap"""
...
print("Iso nump = ", nump, "nums = ", nums, "dt = ", dt, "D1 = ", D1, " D2 = ", D2, "--- %s seconds ---" % (time.time() - start_time))
...
=======
>>>>>>> e43d2fe0879421d252932c80e1e1f36f455c1b71
...
plt.legend()
<<<<<<< HEAD
plt.savefig(f'Hist_Str_{N}_{R}_{r}_{nump}_{nums}_{D1}_{D2}.png')
#plt.show()
=======
plt.savefig(f'Hist_Iso_{N}_{R}_{r}_{nump}_{nums}_{D1}_{D2}.png')
plt.show()
>>>>>>> e43d2fe0879421d252932c80e1e1f36f455c1b71
...
plt.savefig(f'Prob_Str_{N}_{R}_{r}_{nump}_{nums}_{D1}_{D2}.png')
#plt.show()
...
plt.ylabel("Time, t")
plt.colorbar()
plt.savefig(f'Heat_Str_{N}_{R}_{r}_{nump}_{nums}_{D1}_{D2}.png')
=======
plt.imshow(np.flipud(PDF1D/nump), cmap = 'flag', extent = [0, 1, dt, dt*nums], aspect = "auto")
plt.xlabel("Distance, norm(x)")
plt.ylabel("Time, t")
plt.colorbar()
plt.savefig(f'Heat_Ito_{N}_{R}_{r}_{nump}_{nums}_{D1}_{D2}.png')
#print(Z)
>>>>>>> e43d2fe0879421d252932c80e1e1f36f455c1b71
