...
plt.legend()
plt.savefig(f'Images/Hist_Iso_{R}_{nump}_{nums}_{D1}_{D2}.png')
#plt.show()
...
plt.savefig(f'Images/Prob_Iso_{R}_{nump}_{nums}_{D1}_{D2}.png')
#plt.show()
...
plt.ylabel("Time, t")
plt.colorbar()
plt.savefig(f'Images/Heat_Iso_{R}_{nump}_{nums}_{D1}_{D2}.png')
