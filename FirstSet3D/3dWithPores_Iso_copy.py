...
plt.legend()
plt.savefig(f'Hist_Iso1_{N}_{R}_{r}_{nump}_{nums}_{D1}_{D2}.png')
#plt.show()
...
plt.savefig(f'Prob_Iso1_{N}_{R}_{r}_{nump}_{nums}_{D1}_{D2}.png')
#plt.show()
...
plt.ylabel("Time, t")
plt.colorbar()
plt.savefig(f'Heat_Iso1_{N}_{R}_{r}_{nump}_{nums}_{D1}_{D2}.png')
