...
plt.legend()
plt.savefig(f'Hist_Str1_{N}_{R}_{r}_{nump}_{nums}_{D1}_{D2}.png')
#plt.show()
...
plt.savefig(f'Prob_Str1_{N}_{R}_{r}_{nump}_{nums}_{D1}_{D2}.png')
#plt.show()
...
plt.ylabel("Time, t")
plt.colorbar()
plt.savefig(f'Heat_Str1_{N}_{R}_{r}_{nump}_{nums}_{D1}_{D2}.png')
